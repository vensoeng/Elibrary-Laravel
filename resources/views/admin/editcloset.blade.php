...
<head>
    ...
    <title>Edite Closet | {{$closetnum->title}}</title>
    <!-- this is root  -->
    ...
    <div class="web-form web-form-active" id="book-form">
        <div class="web-form-body">
            ...
            <div class="head df-s">
                ...
                <a><span>ទម្រង់កែប្រែ{{$closetnum->title}}</span></a>
                <div class="icon-ra icon-sm df-c" onclick="location.href='{{route('admin')}}'">
                    <i class="fa-solid fa-xmark"></i>
                </div>
            </div>
            <form action="{{route('updateclosetnum',$closetnum->id)}}" method="post" class="db-c">
                @csrf
                @method('PUT')
                <!-- this is content  -->
                <div class="con db-c">
                            ...
                            <div class="box">
                                ...
                                <div class="txt-title">
                                    ...
                                    <div class="txt-title-box">
                                        <input type="text" value="{{$closetnum->title}}" placeholder="បញ្ចូលចំណងជើងជួរ" name="txt-closetnum">
                                    </div>
                                </div>
