    ...
    <div class="web-form web-form-active" id="book-form">
        <div class="web-form-body">
            ...
            <div class="head df-s">
                ...
                <a><span>ទម្រង់កែប្រែឬលុប{{$rage->title}}</span></a>
                <div class="icon-ra icon-sm df-c" onclick="location.href='{{route('admin')}}'">
                    <i class="fa-solid fa-xmark"></i>
                </div>
            </div>
            <form action="{{route('updaterage',$rage->id)}}" method="post" class="db-c">
                @csrf
                @method('PUT')
                <!-- this is content  -->
                <div class="con db-c">
                            ...
                            <div class="box">
                                ...
                                <div class="txt-title">
                                    ...
                                    <div class="txt-title-box">
                                        <input type="text" value="{{$rage->title}}" placeholder="បញ្ចូលចំណងជើងជួរ" name="txt-range">
                                    </div>
                                </div>
                                    ...
                                    <div class="box">
                                        <ul>
                                            @foreach ($rages as $rage)
                                                <li class="df-l">
                                                    <a href="{{route('editrang', $rage->id)}}" class="icon icon-ra icon-ra-sm"><i class="fa-solid fa-xmark"></i></a>
                ...
                <div class="submit-form">
                    <div class="box df-c">
                        <button type="submit" class="btn icon-ra">កែប្រែជួរថ្មី</button>
                    </div>
                </div>
            </form>
        </div>
